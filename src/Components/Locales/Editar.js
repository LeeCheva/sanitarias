...
class Editar extends React.Component {
	...
	return(
		<React.Fragment>
		<Header onDrawerToggle={handleDrawerToggle} Titulo={"Editar Local Farmaceutico"} />
		<form className={useStyles.root} noValidate autoComplete="off">
		<div className={useStyles.Txt}><TextField id="standard-basic" label="Nombre Comercial" /></div>
		<div className={useStyles.Txt}><TextField id="standard-basic" label="Razon Social" /></div>
		<div className={useStyles.Txt}><TextField id="standard-basic" label="RUC" /></div>
        ...
        <InputLabel id="demo-simple-select-label">Estado de Licencia</InputLabel>
        <Select
