...
function createData(equipo, informe, fecha, nombre,dueño,inspector,tipo,estado,opciones) {
  return { equipo, informe, fecha, nombre,dueño,inspector, tipo,estado,opciones};
}
...
function StickyHeadTable(props) {
  ...
  return (    
    ...
    <Header onDrawerToggle={handleDrawerToggle} Titulo={"Inspecciones Sanitarias"} />
    ...
    {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => (
      ...
      <TableCell component="th" scope="row">{row.equipo}</TableCell>
      ...
      <Button size="small" variant="contained" color="primary"  component={Link} to="/Dashboard/InspeccionesSanitarias/Editar">Editar</Button>
