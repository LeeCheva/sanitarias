...
function createData(informe, establecimiento,inspector,equipo,programa, fecha,estado,acciones) {
	return {informe, establecimiento,inspector,equipo,programa, fecha,estado,acciones};
}

const rows = [
createData('Equipo 1', '###########', 'dd/mm/aaaa','Nombre 1','Dueño','inspector', 'tipo','En Proceso'),
createData('Equipo 2', '###########', 'dd/mm/aaaa','Nombre 2','Dueño','inspector', 'tipo','No Conforme'),
createData('Equipo 3', '###########', 'dd/mm/aaaa','Nombre 3','Dueño','inspector', 'tipo','Conforme'),
createData('Equipo 4', '###########', 'dd/mm/aaaa','Nombre 4','Dueño','inspector', 'tipo','En trámite'),
...
function InspeccionesBusqueda(props) {
  ...
  const [labelWidth, setLabelWidth] = React.useState(0);
	...
	return(
		<React.Fragment>
		<Header onDrawerToggle={handleDrawerToggle} Titulo={"Inspecciones Sanitarias"}  opt={"inspe_sani_bus"}/>
		<main>
		<Container fixed>
		<Grid container 
		spacing={3} 
		...
		<Grid item xs={5}>
		<TextField id="outlined-search" fullWidth  label="Nombre del Establecimiento" variant="outlined" />
		</Grid>
		<Grid item xs={3}>
        ...
        <InputLabel ref={inputLabel} htmlFor="outlined-inspector-native-simple">
          Nombres y Apellidos
        </InputLabel>
        <Select
          native
		...
		{rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => (
			...
			<TableCell component="th" scope="row">{row.informe}</TableCell>
